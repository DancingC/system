<template>
  <section>
    ...
    <el-table :data="tableData" border style="width:100%">
      ...
      <el-table-column prop="monitorTasks" label="监测任务"></el-table-column>
      <el-table-column prop="downCapital" label="下达资金（万）"></el-table-column>
      <el-table-column prop="sjjc_point" label="实际监测点数"></el-table-column>
      <el-table-column label="已拨付资金">
        <el-table-column prop="jc_point" label="监测点数"></el-table-column>
        <el-table-column prop="money" label="资金（万）"></el-table-column>
      </el-table-column>
    ...
    >
      ...
      >
        ...
        <el-row>
          <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
            <el-form-item label="灾种" prop="city">
              <el-select v-model="popform.city" class="resetWidth">
